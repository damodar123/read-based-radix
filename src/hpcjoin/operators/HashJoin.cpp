...
void HashJoin::join() {
	...
	hpcjoin::tasks::NetworkPartitioning *networkPartitioning = new hpcjoin::tasks::NetworkPartitioning(this->numberOfNodes, this->nodeId, this->innerRelation, this->outerRelation, 
