...
#ifdef MODIFIED_NETWORK_PARTITIONING_FANOUT
	static const uint64_t NETWORK_PARTITIONING_FANOUT = MODIFIED_NETWORK_PARTITIONING_FANOUT;
#else
	static const uint64_t NETWORK_PARTITIONING_FANOUT = 10;
#endif
#ifdef MODIFIED_LOCAL_PARTITIONING_FANOUT
	static const uint64_t LOCAL_PARTITIONING_FANOUT = MODIFIED_LOCAL_PARTITIONING_FANOUT;
#else
